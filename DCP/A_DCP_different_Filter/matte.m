% DISCLAIMER
% We did not write this code, and it is provided as an example. 
% We used this code for time consuming comparison to our methods that we
% implemented

function rt = matte( img, t )
