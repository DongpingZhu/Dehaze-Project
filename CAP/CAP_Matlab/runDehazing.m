...
imwrite(dR, 'result/originalDepthMap.png');
imwrite(refineDR, 'result/refineDepthMap.png');
...
imwrite(tR, 'result/transmission.png');
...
saveName = ['result/' num2str(r) '_beta' num2str(beta) '.png'];
imwrite(J, saveName);
