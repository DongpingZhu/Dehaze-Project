...
for imageRow = 2:imageSize(1)-1
    for imageCol = 2:imageSize(2)-1
        ...
        %windowMean is µk which is mean of indensities of window
        windowMean       = transpose(mean(windowFlat));
        %windowCovariance is ? which is covariance of indensities of window
